...
from esphome.const import CONF_GAIN, CONF_NUMBER, ICON_FLASH, UNIT_VOLT, CONF_ID, CONF_NAME
from . import cd74hc4067_ns, CD74HC4067Component

DEPENDENCIES = ['cd74hc4067']

CD74HC4067Sensor = cd74hc4067_ns.class_('CD74HC4067Sensor', sensor.Sensor, cg.PollingComponent,
